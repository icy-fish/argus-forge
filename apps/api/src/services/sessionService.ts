  ...
  async timeline(id: string) {
    ...
    for (const span of spans) {
      spanMap.set(span.id, {
        ...
        toolArguments: parseJsonText(span.toolCall?.redactedArguments ?? null) ?? span.toolCall?.argumentsSummary,
        toolOutput: span.toolCall?.resultSummary,
        toolErrorCode: span.toolCall?.errorCode,
